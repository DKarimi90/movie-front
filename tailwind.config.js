  ...
  theme: {
    extend: {
      keyframes: {
        ...
        test: {
          '0%': { transform: 'translateY(-10vh)', opacity: 0, color: 'white' },
          ...
          '100%': { transform: 'translateY(0vh)', opacity: 1, color: 'tomato' },
        }, 
        righty: {
          '0%' : {transform: 'translateX(150%)', opacity: 0, color: 'white'}, 
          '10%' : {transform: 'translateX(0%)', opacity: 1, color: 'gray'}, 
          '35%' : {transform: 'translateX(0%)', opacity: 1, color: 'var(--primary)'}, 
          '70%' : {transform: 'translateX(0%)', opacity: 1, color: 'red'},
          '100%' : {transform: 'translateX(0%)', opacity: 1, color: 'tomato'},
        },  
        lefty: {
          '0%' : {transform: 'translateX(-150%)', opacity: 0, color: 'white'}, 
          '10%' : {transform: 'translateX(0%)', opacity: 1, color: 'gray'}, 
